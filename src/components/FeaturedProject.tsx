        ...
        >
          ...
          <div className="w-full lg:w-[48%] p-6 sm:p-8 lg:p-12 xl:p-14 flex flex-col justify-center relative">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
               <a href="#project-gallery-ghausi" onClick={(e) => handleScroll(e, 'project-gallery-ghausi')} className="btn-primary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 View Layouts
               </a>
               <a href="tel:+918969652817" className="btn-secondary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 Call Now
               </a>
               <a href="https://wa.me/918969652817" target="_blank" rel="noopener noreferrer" className="group relative w-full py-4 bg-[#25D366] text-white rounded-full font-semibold text-sm flex items-center justify-center gap-2 hover:scale-[1.02] transition-all duration-300 shadow-[0_0_20px_rgba(37,211,102,0.2)] border border-[#25D366]/50 min-h-[56px] md:min-h-0">
               ...
               <a href="https://drive.google.com/file/d/1jh4LzzA_hAuX7jLdYCjoObPpic9zzu_-/view" target="_blank" rel="noopener noreferrer" className="btn-primary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 View Brochure
               </a>
             </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="w-full lg:w-[48%] p-8 lg:p-12 xl:p-14 flex flex-col justify-center relative">
             ...
             {/* Buttons Grid */}
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
               <a href="#project-gallery-golden-heights" onClick={(e) => handleScroll(e, 'project-gallery-golden-heights')} className="btn-primary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 View Layouts
               </a>
               <a href="tel:+918969652817" className="btn-secondary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 Call Now
               ...
               <a href="https://drive.google.com/file/d/1jmyGUK0fI6e6Qte3bvb4Ck7DGP-Q_4iA/preview" target="_blank" rel="noopener noreferrer" className="btn-primary w-full py-4 text-sm flex items-center justify-center min-h-[56px] md:min-h-0">
                 View Brochure
               </a>
             </div>
          </div>
